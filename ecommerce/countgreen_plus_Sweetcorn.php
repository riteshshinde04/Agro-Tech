...
<html lang="en">
  <head>
    ...
    <title>COUNTGREEN PLUS SWEETCORN</title>
  </head>
    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/countgreen_plus_sweetcorn_seeds.jpg"  id="zoom" alt="TRUST BASKET NEEM POWDER" />
          </div>
        </div>
        <div class="right">
          <span><a href="index.php">Home</a>/<a href="">Seeds</a></span>
          <h1>Countgreen plus sweetcorn</h1>
          ...
          <h3>Product Detail</h3>
            <p>
<br><br>Sweet corn is a grass family cereal plant that produces an edible grain. Sweet corn is related to grain corn. Its composition is unique since it contains one or more genes that inhibit the conversion of carbohydrates to starch. It is harvested when its water content reaches approximately 70%. It is a good source of carbohydrates, fiber, and vitamins, particularly group B vitamins.
<br><br>Sweetcorn will get ready for harvest once the tassels on the top turn dark brown in colour. Twist the cob downward by picking it from the ear and plunge into cold water to retain the sweetness.
<br><br>Keep the planting site for sweetcorn plants evenly moist during the growing stage since dry soil may lead to wilting.
<br><br>Sweet corn is a healthy addition to your diet, Sweet corn is a starchy vegetable that doubles as a functional food, Starchy means it is high in carbohydrate content.
        </div>
      </div>
    </section>
