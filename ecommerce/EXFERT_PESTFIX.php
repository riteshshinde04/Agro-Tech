    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/pest_fix.jpg"  id="zoom" alt="EXFERT PESTFIX" />
          </div>
        </div>
        <div class="right">
          <span><a href="index.php">Home</a>/<a href="">Pesticides</a></span>
          <h1>Exfert Pestfix</h1>
          ...
          <h3>Product Detail</h3>
            <p>
                Pest fix contains various plant and herbal extracts specially chosen for their great insect, pest and fungal control abilities
                <br><br>It Acts As A Preventive Insecticide, Pesticide And Fungicide
                <br><br>Pest Fix has wide spectrum control against all kinds of Mites, white fly and aphids. It penetrates leaf tissue, where its trans laminar activity provides extended residual control of mites feeding on both upper and lower surface of leaves. It blocks the sucking activity of mites. Lesser number of sprays. It has more photosynthesis activity. Pest fix application does not show any residue on the final crop and hence complete solvent residue free yield is obtained
                <br><br>Pest fix does not harm the plant friendly insects and pest which are beneficial to the plants like bees, butterflies, etc. The use of various extracts makes sure that the insect or pest does not develop any kind of resistance to Pest fix unlike most other chemical pesticides
