...
<html lang="en">
  <head>
    ...
    <title>SAKSHI FARMS BASMATI PADDY</title>
  </head>
    ...
    <section class="section product-detail">
      <div class="details container">
        <div class="left image-container">
          <div class="main">
            <img src="./images/sakshi_farm_basmati.jpg"  id="zoom" alt="TRUST BASKET NEEM POWDER" />
          </div>
        </div>
        <div class="right">
          <span><a href="index.php">Home</a>/<a href="">Seeds</a></span>
          <h1>Sakshi farm basmati paddy</h1>
          ...
          <h3>Product Detail</h3>
            <p>
<br><br>HIGH YIELD OF 17 to 18 Quintal per Acre
<br><br>CROP DURATION 140 TO 145 DAYS
<br><br>HIGHLY PROFITABLE PADDY VARIETY
            </p>
        </div>
      </div>
    </section>
