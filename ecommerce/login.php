...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (empty($err)) {
            ...
            if (mysqli_stmt_num_rows($stmt) == 1) {
                ...
                if (mysqli_stmt_fetch($stmt)) {
                    if (password_verify($password, $hashed_password)) {
                        ...
                        $_SESSION["error"] = "Wrong username or password. Please login with correct credentials.";
        ...
        $_SESSION["error"] = "Username not found. Please sign up if you don't have an account.";
        header("location: login.html");
        exit;
    }
}
